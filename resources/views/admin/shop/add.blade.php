...
<div class="callout-danger container-fluid" >
    ...
    <form method="post" action="" enctype="multipart/form-data" >
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control"  placeholder="name" name="shop_name" value="{{old('shop_name')}}">
        </div>
        <div class="form-group">
        ...
        {{--<div class="form-group">--}}
            ...
            {{--<input type="file" id="exampleInputFile" name="shop_img" value="{{old('shop_img')}}">--}}
            {{--<p class="help-block"></p>--}}
        {{--</div>--}}
        <div class="form-group" >
            <label>图像</label>
           <input type="text" class="form-control" id="img" name="shop_img">
