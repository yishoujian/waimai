...
<div class="callout-danger container-fluid" >
    ...
    <form method="post" action="" enctype="multipart/form-data" >
        ...
        <div class="form-group">
            ...
            <input type="text" id="exampleInputFile" name="content" value="{{old('content',$activitys->title)}}">
            <p class="help-block"></p>
        </div>

        <div class="form-group">
            <label for="exampleInputEmail1">活动内容</label>
            <input type="text" class="form-control"  placeholder="活动内容" name="title" value="{{old('title',$activitys->content)}}">
        </div>


<div class="form-group">
    <label for="exampleInputFile">活动开始时间</label>
    <input type="date" id="exampleInputFile" name="start_time" value="{{old('start_time',$activitys->start_time)}}">
    <p class="help-block"></p>
</div>
<div class="form-group">
    <label for="exampleInputFile">活动结束时间</label>
    <input type="date" id="exampleInputFile" name="end_time" value="{{old('end_time',$activitys->end_time)}}">
    <p class="help-block"></p>
</div>
