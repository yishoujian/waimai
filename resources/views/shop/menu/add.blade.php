...
<div class="callout-danger container-fluid" >
    ...
    <form method="post" action="" enctype="multipart/form-data" >
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control"  placeholder="菜名" name="goods_name" value="{{old('goods_name')}}">
            <div class="form-group">
            </div>
            <div class="form-group">
            ...
            <div>
                ...
                <div class="form-group">
                    ...
                    <input type="file" id="exampleInputFile" name="goods_img" value="{{old('goods_img')}}">
            ...
            <input type="text" id="exampleInputFile" name="goods_price" value="{{old('goods_price')}}">
            <p class="help-block"></p>
        </div>
                <div>
                    <label for="exampleInputFile">所属商家分类ID</label>
                    <select name='shop_id'>
